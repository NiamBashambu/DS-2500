...
plt.plot(k_values, recall_scores, marker='o', linestyle='-', color='pink', label='Recall')
plt.plot(k_values, precision_scores, marker='o', linestyle='-', color='purple', label='Precision')
